...
ptRouter.post('/plans', authMiddleware, requireAdmin(), createPTPlan);
...
ptRouter.get('/plans', authMiddleware, requirePosition(['admin', 'manager', 'sales', 'receptionist']), getPTPlans);

// Update Plan - Admin Only
ptRouter.put('/plans/:id', authMiddleware, requireAdmin(), updatePTPlan);

// Toggle Status - Admin Only
ptRouter.patch('/plans/:id/status', authMiddleware, requireAdmin(), togglePTPlanStatus);
...
ptRouter.post('/assignments', authMiddleware, requirePosition(['admin', 'manager', 'sales']), assignPT);
...
ptRouter.get('/assignments', authMiddleware, getPTAssignments);
...
ptRouter.post('/assignments/:id/session', authMiddleware, requirePosition(['admin', 'manager', 'trainer']), logPTSession);

// Check Expiry - Admin/Manager or automated
ptRouter.post('/expiry-check', authMiddleware, requireAdminOrManager(), checkPTExpiry);
